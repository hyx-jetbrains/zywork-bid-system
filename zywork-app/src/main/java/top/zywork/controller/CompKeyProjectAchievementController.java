...
public class CompKeyProjectAchievementController extends BaseController {
    ...
    @HideProperty(url = "/comp-key-projecachievement/user/pager-cond", properties = {"markMoney"})
    public ResponseStatusVO userListPageByCondition(HttpServletRequest request, @RequestBody CompKeyProjectAchievementQuery compKeyProjectAchievementQuery) {
        ResponseStatusVO responseStatusVO = listPageByCondition(compKeyProjectAchievementQuery);
