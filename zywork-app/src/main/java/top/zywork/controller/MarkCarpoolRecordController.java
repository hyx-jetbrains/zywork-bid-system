...
public class MarkCarpoolRecordController extends BaseController {
    ...
    public ResponseStatusVO saveCarpoolRecord(@PathVariable("carpoolId") Long carpoolId) {
        ...
        userNoticeVO.setPageUrl(NoticeConstants.markCarpoolUrl);
        ...
        userNoticeVO.setDetailContent("您发起的开标拼车由“"+markCarpoolVO.getStartCity()+"/"+markCarpoolVO.getStartAddr()+ "” - “"+ markCarpoolVO.getEndCity()+"/"+markCarpoolVO.getEndAddr()+"”有一条新的申请记录，具体内容可点击《立即查看》按钮前往查看");
