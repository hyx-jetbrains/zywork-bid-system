...
/**
 * CompKeyProjectAchievementQuery查询对象类<br/>
 *
 * 创建于2019-04-20<br/>
 *
 ...
 * @version 1.0
 */
public class CompKeyProjectAchievementQuery extends PageQuery {

    private static final long serialVersionUID = -9223372035359651725L;
    ...
    public CompKeyProjectAchievementQuery () {}

    public CompKeyProjectAchievementQuery (Long id, Long idMin, Long idMax, Long compId, Long compIdMin, Long compIdMax, String projectName, String buildComp, String markMoney, Date startDate, Date startDateMin, Date startDateMax, Date endDate, Date endDateMin, Date endDateMax, Integer version, Integer versionMin, Integer versionMax, Date createTime, Date createTimeMin, Date createTimeMax, Date updateTime, Date updateTimeMin, Date updateTimeMax, Byte isActive, Byte isActiveMin, Byte isActiveMax) {
        this.id = id;
		this.idMin = idMin;
		this.idMax = idMax;
		this.compId = compId;
    ...
    public String toString() {
        return "CompKeyProjectAchievementQuery {" +
                "id = " + id + 
				", idMin = " + idMin + 
				", idMax = " + idMax + 
				", compId = " + compId + 
