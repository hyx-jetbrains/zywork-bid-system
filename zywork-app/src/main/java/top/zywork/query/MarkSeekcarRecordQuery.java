...
/**
 * MarkSeekcarRecordQuery查询对象类<br/>
 *
 * 创建于2019-05-14<br/>
 *
 ...
 * @version 1.0
 */
public class MarkSeekcarRecordQuery extends PageQuery {

    private static final long serialVersionUID = -9223372034817164162L;
    ...
    public MarkSeekcarRecordQuery () {}

    public MarkSeekcarRecordQuery (Long id, Long idMin, Long idMax, Long userId, Long userIdMin, Long userIdMax, Long markSeekcarId, Long markSeekcarIdMin, Long markSeekcarIdMax, Integer version, Integer versionMin, Integer versionMax, Date createTime, Date createTimeMin, Date createTimeMax, Date updateTime, Date updateTimeMin, Date updateTimeMax, Byte isActive, Byte isActiveMin, Byte isActiveMax) {
        this.id = id;
		this.idMin = idMin;
		this.idMax = idMax;
		this.userId = userId;
