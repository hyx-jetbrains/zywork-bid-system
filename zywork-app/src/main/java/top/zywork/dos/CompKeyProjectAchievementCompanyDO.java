...
/**
 * CompKeyProjectAchievementCompanyDO数据对象实体类<br/>
 *
 * 创建于2019-06-12<br/>
 *
 ...
 * @version 1.0
 */
public class CompKeyProjectAchievementCompanyDO extends BaseDO {

    private static final long serialVersionUID = -9223372035852291335L;
    ...
    public String toString() {
        return "CompKeyProjectAchievementCompanyDO {" +
