...
/**
 * ProjectResourceResourceDO数据对象实体类<br/>
 *
 * 创建于2019-05-24<br/>
 *
 ...
 * @version 1.0
 */
public class ProjectResourceResourceDO extends BaseDO {

    private static final long serialVersionUID = -9223372035765744329L;
    ...
    public ProjectResourceResourceDO () {}

    public ProjectResourceResourceDO (Long projectResourceId, Long projectResourceProjectId, Long projectResourceResourceId, Byte projectResourceResType, Integer projectResourceVersion, Date projectResourceCreateTime, Date projectResourceUpdateTime, Byte projectResourceIsActive, Long resourceUserId, String resourceMimeType, String resourceUrl, String resourceExtension) {
    ...
    public String toString() {
        return "ProjectResourceResourceDO {" +
