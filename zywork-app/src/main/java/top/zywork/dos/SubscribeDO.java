...
public class SubscribeDO extends BaseDO {
    ...
    private static final long serialVersionUID = -9223372034731071975L;
    ...
    public SubscribeDO (Long id, Long userId, String city, String projectType, Long minMoney, Long maxMoney, String tenderee, String aptitudeType, String keyword, Integer isSubscribe, Integer version, Date createTime, Date updateTime, Byte isActive) {
        this.id = id;
		this.userId = userId;
		this.city = city;
