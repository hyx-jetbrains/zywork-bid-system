 ...
 * @version 1.0
 */
public class UserUserCouponDO extends BaseDO {

    private static final long serialVersionUID = -9223372036067387746L;
    ...
    public UserUserCouponDO () {}

    public UserUserCouponDO (Long userCouponId, Long userCouponUserId, Long userCouponCouponId, Integer userCouponUseStatus, Integer userCouponVersion, Date userCouponCreateTime, Date userCouponUpdateTime, Byte userCouponIsActive, String couponType, Long couponMoney, Date couponValidTime) {
