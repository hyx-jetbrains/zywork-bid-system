...
/**
 * CompWaterAchievementCompanyDO数据对象实体类<br/>
 *
 * 创建于2019-06-12<br/>
 *
 ...
 * @version 1.0
 */
public class CompWaterAchievementCompanyDO extends BaseDO {

    private static final long serialVersionUID = -9223372035125771720L;
    ...
    public String toString() {
        return "CompWaterAchievementCompanyDO {" +
