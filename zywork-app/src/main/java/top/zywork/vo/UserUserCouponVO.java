 ...
 * @version 1.0
 */
public class UserUserCouponVO extends BaseVO {

    private static final long serialVersionUID = -9223372036371213681L;
    ...
    public UserUserCouponVO () {}

    public UserUserCouponVO (Long userCouponId, Long userCouponUserId, Long userCouponCouponId, Integer userCouponUseStatus, Integer userCouponVersion, Date userCouponCreateTime, Date userCouponUpdateTime, Byte userCouponIsActive, String couponType, Long couponMoney, Date couponValidTime) {
