...
/**
 * CompTrafficAchievementCompanyDTO数据传输对象类<br/>
 *
 * 创建于2019-06-12<br/>
 *
 ...
 * @version 1.0
 */
public class CompTrafficAchievementCompanyDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372036326314700L;
    ...
    public String toString() {
        return "CompTrafficAchievementCompanyDTO {" +
