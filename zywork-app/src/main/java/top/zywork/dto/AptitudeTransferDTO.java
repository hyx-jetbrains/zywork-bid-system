 ...
 * @version 1.0
 */
public class AptitudeTransferDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372035969718249L;
    ...
    public AptitudeTransferDTO () {}

    public AptitudeTransferDTO (Long id, Long userId, Byte type, String title, String compAptitudeLevel, String compAptitudeType, String phone, String memo, Integer version, Date createTime, Date updateTime, Byte isActive) {
        this.id = id;
		this.userId = userId;
		this.type = type;
		this.title = title;
