...
/**
 * UserServiceServiceDTO数据传输对象类<br/>
 *
 * 创建于2019-05-28<br/>
 *
 ...
 * @version 1.0
 */
public class UserServiceServiceDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372036246272552L;
    ...
    public UserServiceServiceDTO () {}

    public UserServiceServiceDTO (Long userServiceId, Long userServiceUserId, Long userServiceServiceId, Date userServiceEndDate, Integer userServiceValidYear, Integer userServiceVersion, Date userServiceCreateTime, Date userServiceUpdateTime, Byte userServiceIsActive, String serviceTitle, String serviceMemo, String serviceUrls, Long servicePrice) {
