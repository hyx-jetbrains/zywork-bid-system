...
/**
 * UserMarkSeekcarRecordDTO数据传输对象类<br/>
 *
 * 创建于2019-05-17<br/>
 *
 ...
 * @version 1.0
 */
public class UserMarkSeekcarRecordDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372034982206366L;
    ...
    public String toString() {
        return "UserMarkSeekcarRecordDTO {" +
