...
/**
 * UserAptitudeTransferDTO数据传输对象类<br/>
 *
 * 创建于2019-05-15<br/>
 *
 ...
 * @version 1.0
 */
public class UserAptitudeTransferDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372035522422402L;
    ...
    public String toString() {
        return "UserAptitudeTransferDTO {" +
