 ...
 * @version 1.0
 */
public class SysInfoDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372035571578717L;
    ...
    public SysInfoDTO (Long id, String compName, String headIcon, String menuIconMin, String menuIconMax, String defaultHead, String backgroundIcon, String doMain, String compAddr, String compPhone, String compEmail, String compMemo, Integer version, Date createTime, Date updateTime, Byte isActive) {
        this.id = id;
