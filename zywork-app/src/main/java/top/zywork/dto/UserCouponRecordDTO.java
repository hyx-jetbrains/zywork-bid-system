 ...
 * @version 1.0
 */
public class UserCouponRecordDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372035557110248L;
    ...
    public UserCouponRecordDTO () {}

    public UserCouponRecordDTO (Long couponRecordId, Long couponRecordUserId, Long couponRecordCouponId, Long couponRecordOldPrice, Long couponRecordCouponPrice, Long couponRecordPrice, Integer couponRecordVersion, Date couponRecordCreateTime, Date couponRecordUpdateTime, Byte couponRecordIsActive, String couponType, Long couponMoney) {
