...
public class CompInfoWaterAgentJob implements Job {

    private static final Logger logger = LoggerFactory.getLogger(CompInfoWaterAgentJob.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        logger.info("begin to execute CompInfoWaterAgentJob......");
        String path = filesPath + PythonConstants.PAGE_NO_FILE_NAME_COMP_WATER_AGENT;
        String pageNo = IOUtils.getText(path).replaceAll("\r\n", "");
        try {
            companyPythonService.getCompanyInfo(PythonConstants.TYPE_AGENT, PythonConstants.COMP_TYPE_WATER_AGENT, pageNo, PythonConstants.DEFAULT_PAGE_SIXE, PythonConstants.DEFAULT_IS_UPDATE_FLAG);
