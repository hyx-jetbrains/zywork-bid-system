...
public class ProjectConservancyJob implements Job {

    private static final Logger logger = LoggerFactory.getLogger(ProjectConservancyJob.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) {
        ...
        String url = PythonConstants.BASE_URL+PythonConstants.PROJECT_CONSERVANCY;
