...
public class ProjectAnnounceHouseJob implements Job {

    private static final Logger logger = LoggerFactory.getLogger(ProjectAnnounceHouseJob.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) {
        ...
        String url = PythonConstants.BASE_URL+PythonConstants.PROJECT_ANNOUNCE_HOUSE + "?pageNo=" + PythonConstants.DEFAULT_PAGE_NO;;
