...
public class ProjectKeyJob implements Job {

    private static final Logger logger = LoggerFactory.getLogger(ProjectKeyJob.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) {
        ...
        String url = PythonConstants.BASE_URL+"project/key";
