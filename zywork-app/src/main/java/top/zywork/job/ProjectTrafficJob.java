...
public class ProjectTrafficJob implements Job {

    private static final Logger logger = LoggerFactory.getLogger(ProjectTrafficJob.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) {
        ...
        String url = PythonConstants.BASE_URL+"project/traffic";
