...
CREATE TABLE `t_aptitude_transfer`  (
  ...
  `comp_aptitude_level` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '企业资质等级',
...
CREATE TABLE `t_builder`  (
  ...
  `certificate_type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '证书类别',
  `certificate_major_type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '证书专业类型',
  `certificate_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '证书状态',
...
CREATE TABLE `t_builder_req`  (
  ...
  `phone` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '手机号',
  `memo` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '说明',
  `people` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '所需人才',
...
CREATE TABLE `t_comp_aptitude`  (
  ...
  `certificate_num` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '证件号码',
...
CREATE TABLE `t_comp_builder`  (
  ...
  `reg_num` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '注册证件号码',
...
CREATE TABLE `t_comp_house_achievement`  (
  ...
  `build_scale` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '建设规模',
  `region_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '项目所属地区归类',
  `mark_comp` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '中标单位',
  `build_comp` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '建设单位',
...
CREATE TABLE `t_comp_personnel`  (
  ...
  `comp_id` bigint(20) NOT NULL DEFAULT 0 COMMENT '企业编号',
  `name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '姓名',
  `job_title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '职称',
  `job_detail` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '职业资格及专业',
  `version` int(11) NULL DEFAULT 1 COMMENT '版本号',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
...
CREATE TABLE `t_comp_water_devise_achievement`  (
  ...
  `build_comp` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '招标(单位)人',
...
CREATE TABLE `t_company`  (
  ...
  `comp_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '企业名称',
...
CREATE TABLE `t_consult`  (
  ...
  `consult_desc` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '问题说明',
  `reply_user_id` bigint(20) NULL DEFAULT 0 COMMENT '回复人编号',
  `reply_content` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '回复内容',
...
CREATE TABLE `t_project`  (
  ...
  `offer_price` varchar(100) NULL DEFAULT '' COMMENT '要约价(元)',
  `assure_price` varchar(100) NULL DEFAULT '' COMMENT '保证金(万元)',
  `construction_period` int(10) NULL DEFAULT 0 COMMENT '工期(天)',
  ...
  `resource_count` int(10) NULL DEFAULT 1 COMMENT '版本号',
...
CREATE TABLE `t_sys_info`  (
  ...
  `is_active` tinyint(4) NULL DEFAULT 0 COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统信息表' ROW_FORMAT = Dynamic;
