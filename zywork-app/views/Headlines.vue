...
<FormItem label="内容" prop="content">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="头条编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始头条编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束头条编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>头条编号: <span v-text="form.id"></span></p>
<p>标题: <span v-text="form.title"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/headlines/admin/save',
          batchAddUrl: '/headlines/admin/batch-save',
          editUrl: '/headlines/admin/update',
          batchEditUrl: '/headlines/admin/batch-update',
          searchUrl: '/headlines/admin/pager-cond',
          allUrl: '/headlines/admin/all',
          removeUrl: '/headlines/admin/remove/',
          batchRemoveUrl: '/headlines/admin/batch-remove',
