...
<FormItem label="资源类型" prop="mimeType">
	<Input v-model="form.mimeType" placeholder="请输入资源类型"/>
</FormItem>
<FormItem label="资源地址" prop="url">
	<Input v-model="form.url" placeholder="请输入资源地址"/>
</FormItem>
<FormItem label="资源扩展名" prop="extension">
	<Input v-model="form.extension" placeholder="请输入资源扩展名"/>
</FormItem>
...
<FormItem label="资源扩展名" prop="extension">
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始资源编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束资源编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="资源地址" prop="url">
	<Input v-model="searchForm.url" placeholder="请输入资源地址"/>
</FormItem>
<FormItem label="资源扩展名" prop="extension">
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>资源编号: <span v-text="form.id"></span></p>
<p>用户编号: <span v-text="form.userId"></span></p>
<p>资源类型: <span v-text="form.mimeType"></span></p>
<p>资源地址: <span v-text="form.url"></span></p>
<p>资源扩展名: <span v-text="form.extension"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/resource/admin/save',
          batchAddUrl: '/resource/admin/batch-save',
          editUrl: '/resource/admin/update',
          batchEditUrl: '/resource/admin/batch-update',
          searchUrl: '/resource/admin/pager-cond',
          allUrl: '/resource/admin/all',
          removeUrl: '/resource/admin/remove/',
          batchRemoveUrl: '/resource/admin/batch-remove',
          detailUrl: '/resource/admin/one/',
          activeUrl: '/resource/admin/active',
          batchActiveUrl: '/resource/admin/batch-active'
        },
        page: {
          total: 0
        },
