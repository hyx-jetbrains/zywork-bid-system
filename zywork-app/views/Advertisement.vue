...
<FormItem label="图片地址" prop="imgUrl">
	<Input v-model="form.imgUrl" placeholder="请输入图片地址"/>
</FormItem>
...
<FormItem label="URL链接" prop="url">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="轮播广告编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始轮播广告编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束轮播广告编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="内容" prop="content">
	<Input v-model="searchForm.content" placeholder="请输入内容"/>
</FormItem>
<FormItem label="图片地址" prop="imgUrl">
	<Input v-model="searchForm.imgUrl" placeholder="请输入图片地址"/>
</FormItem>
<FormItem label="URL链接" prop="url">
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>轮播广告编号: <span v-text="form.id"></span></p>
<p>轮播图标题: <span v-text="form.title"></span></p>
<p>内容: <span v-text="form.content"></span></p>
<p>图片地址: <span v-text="form.imgUrl"></span></p>
