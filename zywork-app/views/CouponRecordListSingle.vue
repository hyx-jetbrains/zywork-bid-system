  ...
  <div>
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="抵扣券使用记录编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始抵扣券使用记录编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束抵扣券使用记录编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="原价"><Row>
	...
	<InputNumber v-model="searchForm.oldPriceMin" placeholder="请输入开始原价" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="oldPriceMax">
	<InputNumber v-model="searchForm.oldPriceMax" placeholder="请输入结束原价" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="优惠价"><Row>
	<i-col span="11">
	<FormItem prop="couponPriceMin">
	<InputNumber v-model="searchForm.couponPriceMin" placeholder="请输入开始优惠价" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="couponPriceMax">
	<InputNumber v-model="searchForm.couponPriceMax" placeholder="请输入结束优惠价" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情">
      <p>抵扣券使用记录编号: <span v-text="form.id"></span></p>
<p>用户编号: <span v-text="form.userId"></span></p>
<p>抵扣券编号: <span v-text="form.couponId"></span></p>
<p>原价: <span v-text="form.oldPrice"></span></p>
<p>优惠价: <span v-text="form.couponPrice"></span></p>
