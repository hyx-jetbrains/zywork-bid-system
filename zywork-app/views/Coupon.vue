...
<FormItem label="有效期至" prop="validTime">
	<DatePicker @on-change="form.validTime=$event" :value="form.validTime" placeholder="请输入有效期至" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
...
<FormItem label="有效期至" prop="validTime">
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始抵扣券编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束抵扣券编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="金额"><Row>
	...
	<InputNumber v-model="searchForm.moneyMin" placeholder="请输入开始金额" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="moneyMax">
	<InputNumber v-model="searchForm.moneyMax" placeholder="请输入结束金额" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="数量"><Row>
	<i-col span="11">
	<FormItem prop="couponCountMin">
	<InputNumber v-model="searchForm.couponCountMin" placeholder="请输入开始数量" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="couponCountMax">
	<InputNumber v-model="searchForm.couponCountMax" placeholder="请输入结束数量" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="有效期至"><Row>
	<i-col span="11">
	<FormItem prop="validTimeMin">
	<DatePicker @on-change="searchForm.validTimeMin=$event" :value="searchForm.validTimeMin" placeholder="请输入开始有效期至" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="validTimeMax">
	<DatePicker @on-change="searchForm.validTimeMax=$event" :value="searchForm.validTimeMax" placeholder="请输入结束有效期至" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>抵扣券编号: <span v-text="form.id"></span></p>
<p>抵用券类别: <span v-text="form.type"></span></p>
<p>金额: <span v-text="form.money"></span></p>
<p>数量: <span v-text="form.couponCount"></span></p>
<p>有效期至: <span v-text="form.validTime"></span></p>
