...
<FormItem label="问题解答" prop="content">
	<Input v-model="form.content" placeholder="请输入问题解答"/>
</FormItem>
...
<FormItem label="问题解答" prop="content">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="常见问题编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始常见问题编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束常见问题编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="问题解答" prop="content">
	<Input v-model="searchForm.content" placeholder="请输入问题解答"/>
</FormItem>
