...
<FormItem label="回复人编号" prop="replyUserId">
	<InputNumber v-model="form.replyUserId" placeholder="请输入回复人编号" style="width: 100%;"/>
</FormItem>
...
<FormItem label="回复时间" prop="replyTime">
	<DatePicker @on-change="form.replyTime=$event" :value="form.replyTime" placeholder="请输入回复时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
...
<FormItem label="回复时间" prop="replyTime">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="咨询编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始咨询编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束咨询编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="回复人编号"><Row>
	<i-col span="11">
	<FormItem prop="replyUserIdMin">
	<InputNumber v-model="searchForm.replyUserIdMin" placeholder="请输入开始回复人编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="replyUserIdMax">
	<InputNumber v-model="searchForm.replyUserIdMax" placeholder="请输入结束回复人编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/consult/admin/save',
          batchAddUrl: '/consult/admin/batch-save',
          editUrl: '/consult/admin/update',
          batchEditUrl: '/consult/admin/batch-update',
          searchUrl: '/consult/admin/pager-cond',
          allUrl: '/consult/admin/all',
          removeUrl: '/consult/admin/remove/',
          batchRemoveUrl: '/consult/admin/batch-remove',
