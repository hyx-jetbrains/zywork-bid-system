  ...
  <div>
    ...
    <Modal v-model="modal.add" title="添加" @on-visible-change="changeModalVisibleResetForm('addForm', $event)">
      <Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
        <FormItem label="消息编号" prop="messageId">
	<InputNumber v-model="form.messageId" placeholder="请输入消息编号" style="width: 100%;"/>
</FormItem>
<FormItem label="用户编号" prop="userId">
	<InputNumber v-model="form.userId" placeholder="请输入用户编号" style="width: 100%;"/>
</FormItem>
<FormItem label="是否已读" prop="isRead">
	<InputNumber v-model="form.isRead" placeholder="请输入是否已读" style="width: 100%;"/>
</FormItem>
...
<FormItem label="是否已读" prop="isRead">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="消息发送编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始消息发送编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束消息发送编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否已读"><Row>
	<i-col span="11">
	<FormItem prop="isReadMin">
	<InputNumber v-model="searchForm.isReadMin" placeholder="请输入开始是否已读" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="isReadMax">
	<InputNumber v-model="searchForm.isReadMax" placeholder="请输入结束是否已读" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>消息发送编号: <span v-text="form.id"></span></p>
<p>消息编号: <span v-text="form.messageId"></span></p>
<p>用户编号: <span v-text="form.userId"></span></p>
<p>是否已读: <span v-text="form.isRead"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/user-message/admin/save',
          batchAddUrl: '/user-message/admin/batch-save',
          editUrl: '/user-message/admin/update',
          batchEditUrl: '/user-message/admin/batch-update',
          searchUrl: '/user-message/admin/pager-cond',
          allUrl: '/user-message/admin/all',
          removeUrl: '/user-message/admin/remove/',
          batchRemoveUrl: '/user-message/admin/batch-remove',
          detailUrl: '/user-message/admin/one/',
          activeUrl: '/user-message/admin/active',
          batchActiveUrl: '/user-message/admin/batch-active'
        },
        page: {
          total: 0
        },
