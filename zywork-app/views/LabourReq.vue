...
<FormItem label="求职类型" prop="jobType">
	<Input v-model="form.jobType" placeholder="请输入求职类型"/>
</FormItem>
...
<FormItem label="其他说明" prop="memo">
	<Input v-model="form.memo" placeholder="请输入其他说明"/>
</FormItem>
...
<FormItem label="其他说明" prop="memo">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="劳务需求编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始劳务需求编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束劳务需求编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>劳务需求编号: <span v-text="form.id"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/labour-req/admin/save',
          batchAddUrl: '/labour-req/admin/batch-save',
          editUrl: '/labour-req/admin/update',
          batchEditUrl: '/labour-req/admin/batch-update',
          searchUrl: '/labour-req/admin/pager-cond',
          allUrl: '/labour-req/admin/all',
          removeUrl: '/labour-req/admin/remove/',
          batchRemoveUrl: '/labour-req/admin/batch-remove',
          detailUrl: '/labour-req/admin/one/',
          activeUrl: '/labour-req/admin/active',
          batchActiveUrl: '/labour-req/admin/batch-active'
        },
        page: {
          total: 0
        },
