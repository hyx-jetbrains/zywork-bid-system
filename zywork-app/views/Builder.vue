...
<FormItem label="出生年份" prop="birthday">
	<DatePicker @on-change="form.birthday=$event" :value="form.birthday" placeholder="请输入出生年份" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
<FormItem label="证件地址" prop="certificateAddress">
	<Input v-model="form.certificateAddress" placeholder="请输入证件地址"/>
</FormItem>
<FormItem label="证书类别" prop="certificateType">
	<Input v-model="form.certificateType" placeholder="请输入证书类别"/>
</FormItem>
<FormItem label="证书专业类型" prop="certificateMajorType">
	<Input v-model="form.certificateMajorType" placeholder="请输入证书专业类型"/>
</FormItem>
<FormItem label="证书状态" prop="certificateStatus">
	<Input v-model="form.certificateStatus" placeholder="请输入证书状态"/>
</FormItem>
<FormItem label="注册状态" prop="certificateRegStatus">
	<Input v-model="form.certificateRegStatus" placeholder="请输入注册状态"/>
</FormItem>
<FormItem label="期望年薪" prop="salary">
	<Input v-model="form.salary" placeholder="请输入期望年薪"/>
</FormItem>
...
<FormItem label="说明" prop="memo">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="建造师编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始建造师编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束建造师编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="出生年份"><Row>
	<i-col span="11">
	<FormItem prop="birthdayMin">
	<DatePicker @on-change="searchForm.birthdayMin=$event" :value="searchForm.birthdayMin" placeholder="请输入开始出生年份" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="birthdayMax">
	<DatePicker @on-change="searchForm.birthdayMax=$event" :value="searchForm.birthdayMax" placeholder="请输入结束出生年份" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="证件地址" prop="certificateAddress">
	<Input v-model="searchForm.certificateAddress" placeholder="请输入证件地址"/>
</FormItem>
<FormItem label="证书类别" prop="certificateType">
	<Input v-model="searchForm.certificateType" placeholder="请输入证书类别"/>
</FormItem>
<FormItem label="证书专业类型" prop="certificateMajorType">
	<Input v-model="searchForm.certificateMajorType" placeholder="请输入证书专业类型"/>
</FormItem>
<FormItem label="证书状态" prop="certificateStatus">
	<Input v-model="searchForm.certificateStatus" placeholder="请输入证书状态"/>
</FormItem>
<FormItem label="注册状态" prop="certificateRegStatus">
	<Input v-model="searchForm.certificateRegStatus" placeholder="请输入注册状态"/>
</FormItem>
<FormItem label="期望年薪" prop="salary">
	<Input v-model="searchForm.salary" placeholder="请输入期望年薪"/>
</FormItem>
<FormItem label="手机号" prop="phone">
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>建造师编号: <span v-text="form.id"></span></p>
<p>用户编号: <span v-text="form.userId"></span></p>
<p>姓名: <span v-text="form.name"></span></p>
<p>性别: <span v-text="form.gender"></span></p>
<p>出生年份: <span v-text="form.birthday"></span></p>
<p>证件地址: <span v-text="form.certificateAddress"></span></p>
<p>证书类别: <span v-text="form.certificateType"></span></p>
<p>证书专业类型: <span v-text="form.certificateMajorType"></span></p>
<p>证书状态: <span v-text="form.certificateStatus"></span></p>
<p>注册状态: <span v-text="form.certificateRegStatus"></span></p>
<p>期望年薪: <span v-text="form.salary"></span></p>
...
gender: [
{type: 'string', min: 1, max: 5, message: '必须1-5个字符', trigger: 'blur'}
],
certificateAddress: [
...
{type: 'string', min: 1, max: 4, message: '必须1-4个字符', trigger: 'blur'}
],
salary: [
{type: 'string', min: 1, max: 20, message: '必须1-20个字符', trigger: 'blur'}
],
