...
<FormItem label="工作地点" prop="workAddr">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="工作信息编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始工作信息编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束工作信息编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="身份证号" prop="idNum">
	<Input v-model="searchForm.idNum" placeholder="请输入身份证号"/>
</FormItem>
<FormItem label="工作单位" prop="workUnit">
	<Input v-model="searchForm.workUnit" placeholder="请输入工作单位"/>
</FormItem>
<FormItem label="职务" prop="jobTitle">
	<Input v-model="searchForm.jobTitle" placeholder="请输入职务"/>
</FormItem>
<FormItem label="工作地点" prop="workAddr">
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>工作信息编号: <span v-text="form.id"></span></p>
<p>用户编号: <span v-text="form.userId"></span></p>
<p>身份证号: <span v-text="form.idNum"></span></p>
<p>工作单位: <span v-text="form.workUnit"></span></p>
<p>职务: <span v-text="form.jobTitle"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/user-work/admin/save',
          batchAddUrl: '/user-work/admin/batch-save',
          editUrl: '/user-work/admin/update',
          batchEditUrl: '/user-work/admin/batch-update',
          searchUrl: '/user-work/admin/pager-cond',
          allUrl: '/user-work/admin/all',
          removeUrl: '/user-work/admin/remove/',
          batchRemoveUrl: '/user-work/admin/batch-remove',
          detailUrl: '/user-work/admin/one/',
          activeUrl: '/user-work/admin/active',
          batchActiveUrl: '/user-work/admin/batch-active'
        },
        page: {
          total: 0
        },
...
isActive: null,
        ...
        validateRules: {
          idNum: [
{type: 'string', min: 1, max: 18, message: '必须1-18个字符', trigger: 'blur'}
],
workUnit: [
