...
<FormItem label="公示详情" prop="announceDesc">
	<Input v-model="form.announceDesc" placeholder="请输入公示详情"/>
</FormItem>
...
<FormItem label="第三候选人" prop="thirdCandidate">
	...
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始公示编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束公示编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="公示详情" prop="announceDesc">
	<Input v-model="searchForm.announceDesc" placeholder="请输入公示详情"/>
</FormItem>
<FormItem label="第一候选人" prop="firstCandidate">
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>公示编号: <span v-text="form.id"></span></p>
<p>项目编号: <span v-text="form.projectId"></span></p>
<p>公示详情: <span v-text="form.announceDesc"></span></p>
