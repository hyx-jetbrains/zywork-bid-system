...
<FormItem label="最晚时间" prop="latestTime">
	<DatePicker @on-change="form.latestTime=$event" :value="form.latestTime" placeholder="请输入最晚时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
