...
# 水利工程
def get_conservancy_announce_projects(pageNo):
    # current_announce_conservancy_file = open('current_announce_conservancy_file.txt', 'r+')
    # 获取已爬取的最新的链接
    # current_announce_conservancy_href = current_announce_conservancy_file.readline()
    response = requests.get(url="http://www.jxsggzy.cn/web/jyxx/002003/002003005/"+pageNo+".html")
    ...
    for li in li_list:
        ...
        # if current_announce_conservancy_href != href:
        #     if not latest_flag:
        #         # 清除文件原内容
        #         current_announce_conservancy_file.seek(0)
        #         current_announce_conservancy_file.truncate()
        #         # 记录新链接到文件中
        #         current_announce_conservancy_file.write(href)
        #         latest_flag = True
        # else:
        #     # 网站没有更新新数据，则停止爬取
        #     break
        ...
        projectAnnounce.projectType = '水利工程'
        # 打开招标详情页面
    ...
    # current_announce_conservancy_file.close()
    print(projects)
    return projects
