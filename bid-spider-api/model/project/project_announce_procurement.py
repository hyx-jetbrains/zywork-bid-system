...
# 政府采购
def get_procurement_announce_projects(pageNo):
    # current_announce_procurement_file = open('current_announce_procurement_file.txt', 'r+')
    # 获取已爬取的最新的链接
    # current_announce_procurement_href = current_announce_procurement_file.readline()
    response = requests.get(url="http://www.jxsggzy.cn/web/jyxx/002006/002006004/"+pageNo+".html")
    ...
    for li in li_list:
        ...
        # if current_announce_procurement_href != href:
        #     if not latest_flag:
        #         # 清除文件原内容
        #         current_announce_procurement_file.seek(0)
        #         current_announce_procurement_file.truncate()
        #         # 记录新链接到文件中
        #         current_announce_procurement_file.write(href)
        #         latest_flag = True
        # else:
        #     # 网站没有更新新数据，则停止爬取
        #     break
        ...
        projectAnnounce.projectType = '政府采购'
        # 打开招标详情页面
    ...
    # current_announce_procurement_file.close()
    print(projects)
    return projects
