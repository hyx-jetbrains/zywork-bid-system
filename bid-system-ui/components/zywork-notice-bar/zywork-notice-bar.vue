<template>
	<view v-if="show" class="uni-noticebar" :style="{backgroundColor:backgroundColor,color:color}">
		...
		<view class="uni-noticebar__content" :class="setContenClass">
			...
			<view class="uni-noticebar__content-text" :class="setTextClass" @click="onClick">
