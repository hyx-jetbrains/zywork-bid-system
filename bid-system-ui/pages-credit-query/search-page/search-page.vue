						...
						<view>
							...
							<view>
								<view class="zy-disable-flex">
									...
									<view v-if="item.firstCandidate != null && item.firstCandidate != '' && item.firstCandidate != undefined"
									 class="zy-text-info">
										{{item.firstCandidate}}
									</view>
									<view v-else class="zy-text-info">
								...
								<view class="zy-disable-flex">
									...
									<view v-if="item.thirdCandidate != null && item.thirdCandidate != '' && item.thirdCandidate != undefined"
									 class="zy-text-info">
										{{item.thirdCandidate}}
									</view>
									<view v-else class="zy-text-info">
		...
		methods: {
			...
			refreshCompanyList() {
				...
				if (this.searchVal != null && this.searchVal != '') {
					this.pager.compName = this.searchVal;
				} else {
					this.pager.compName = ''
				}
				uni.showLoading({
			...
			refreshAchievementList(index) {
				this.initPager();
				if (this.searchVal != null && this.searchVal != '') {
					this.pager.projectName = this.searchVal;
				} else {
					this.pager.projectName = ''
				}
				var url = '';
				if (index == 0) {
					// 房屋业绩
			...
			refreshBuilderList() {
				this.initPager();
				if (this.searchVal != null && this.searchVal != '') {
					this.pager.name = this.searchVal;
				} else {
					this.pager.name = ''
				}
				uni.showLoading({
			...
			refreshAptitudeList() {
				this.initPager();
				if (this.searchVal != null && this.searchVal != '') {
					this.pager.certificateDetail = this.searchVal;
				} else {
					this.pager.certificateDetail = ''
				}
				uni.showLoading({
					title: '加载中'
				})
			...
			refreshProjectAnnounceList() {
				this.initPager();
				if (this.searchVal != null && this.searchVal != '') {
					this.pager.firstCandidate = this.searchVal;
				} else {
					this.pager.firstCandidate = ''
				}
				uni.showLoading({
					title: '加载中'
				})
