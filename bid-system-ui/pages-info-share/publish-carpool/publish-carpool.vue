							...
							<view class="uni-list-cell-db">
								...
								<uni-drawer :visible="projectDrawer" mode="right" @close="closeProjectDrawer">
									<uni-list>
										...
										<view class="zy-project-item" v-for="(projectItem, index) in projects" :key="index" @click="chooseProject(projectItem.project.id, projectItem.project.title)">
											...
											<view class="zy-text-mini" style="color: #dd524d; text-align: right;">
												开标时间：
												<text v-if="projectItem.project.openMarkTime !== ''"
