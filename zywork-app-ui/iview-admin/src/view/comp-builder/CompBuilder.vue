	...
	<div>
			...
			<Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
				...
				<FormItem label="性别" prop="gender">
					<Select
					  ...
					  clearable
					  filterable
						@on-change="initGender"
					>
						<i-option v-for="item in GenderList" :value="item.value" :key="item.key">{{item.label}}</i-option>
					</Select>
				</FormItem>
				<FormItem label="注册证件号码" prop="regNum">
					<Input v-model="form.regNum" placeholder="请输入注册证件号码" />
				</FormItem>
				<FormItem label="专业等级" prop="majorLevel">
					<Select
					  v-model="form.majorLevel"
					  placeholder="专业等级"
					  clearable
					  filterable
						@on-change="initMajorLevel"
					>
						<i-option v-for="item in MajorLevelList" :value="item.value" :key="item.key">{{item.label}}</i-option>
					</Select>
				</FormItem>
		...
		<Modal v-model="modal.search" title="高级搜索">
			<Form ref="searchForm" :model="searchForm" :label-width="80">
				<FormItem label="企业建造师编号">
					<Row>
						<i-col span="11">
							<FormItem prop="idMin">
								<InputNumber v-model="searchForm.idMin" placeholder="请输入开始企业建造师编号" style="width: 100%;" />
							</FormItem>
						</i-col>
						<i-col span="2" style="text-align: center">-</i-col>
						<i-col span="11">
							<FormItem prop="idMax">
								<InputNumber v-model="searchForm.idMax" placeholder="请输入结束企业建造师编号" style="width: 100%;" />
							</FormItem>
						</i-col>
					</Row>
				</FormItem>
				...
				<FormItem label="注册证件号码" prop="regNum">
					<Input v-model="searchForm.regNum" placeholder="请输入注册证件号码" />
				</FormItem>
				<FormItem label="专业等级" prop="majorLevel">
					<Input v-model="searchForm.majorLevel" placeholder="请输入专业等级" />
				</FormItem>
				<FormItem label="版本号">
					<Row>
						<i-col span="11">
		...
		<Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
			<p>企业建造师编号: <span v-text="form.id"></span></p>
			<p>企业编号: <span v-text="form.compId"></span></p>
			<p>姓名: <span v-text="form.name"></span></p>
			<p>性别: <span v-text="form.gender"></span></p>
			<p>注册证件号码: <span v-text="form.regNum"></span></p>
			<p>专业等级: <span v-text="form.majorLevel"></span></p>
...
<script>
	...
	import {certificateType, gender} from '@/api/select'
	...
	export default {
		...
		data() {
			return {
				MajorLevelList: certificateType,
				GenderList: gender,
				modal: {
					add: false,
					edit: false,
				...
				urls: {
					addUrl: '/comp-builder/admin/save',
					batchAddUrl: '/comp-builder/admin/batch-save',
					editUrl: '/comp-builder/admin/update',
					batchEditUrl: '/comp-builder/admin/batch-update',
					searchUrl: '/comp-builder/admin/pager-cond',
					allUrl: '/comp-builder/admin/all',
					removeUrl: '/comp-builder/admin/remove/',
					batchRemoveUrl: '/comp-builder/admin/batch-remove',
					detailUrl: '/comp-builder/admin/one/',
					activeUrl: '/comp-builder/admin/active',
					batchActiveUrl: '/comp-builder/admin/batch-active'
				},
				page: {
					total: 0
				},
