...
<FormItem label="合同签订日期" prop="contractDate">
	<DatePicker @on-change="form.contractDate=$event" :value="form.contractDate" placeholder="请输入合同签订日期" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
<FormItem label="中标日期" prop="markDate">
	<DatePicker @on-change="form.markDate=$event" :value="form.markDate" placeholder="请输入中标日期" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
