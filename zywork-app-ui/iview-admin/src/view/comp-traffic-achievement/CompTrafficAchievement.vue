	...
	<div>
		...
		<Modal v-model="modal.add" title="添加" @on-visible-change="changeModalVisibleResetForm('addForm', $event)">
			<Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
				...
				<FormItem label="竣工时间" prop="endDate">
					<DatePicker @on-change="form.endDate=$event" :value="form.endDate" placeholder="请输入竣工时间" type="datetime" format="yyyy-MM-dd HH:mm:ss"
					 style="width: 100%;"></DatePicker>
				</FormItem>
				<FormItem label="验证状态" prop="validStatus">
					<Select
					  v-model="form.validStatus"
					  placeholder="验证状态"
					  clearable
					  filterable
						@on-change="initValidStatus"
					>
						<i-option v-for="item in ValidStatusList" :value="item.value" :key="item.key">{{item.label}}</i-option>
					</Select>
				</FormItem>
		...
		<Modal v-model="modal.search" title="高级搜索">
			<Form ref="searchForm" :model="searchForm" :label-width="80">
				<FormItem label="企业交通业绩编号">
					<Row>
						<i-col span="11">
							<FormItem prop="idMin">
								<InputNumber v-model="searchForm.idMin" placeholder="请输入开始企业交通业绩编号" style="width: 100%;" />
							</FormItem>
						</i-col>
						<i-col span="2" style="text-align: center">-</i-col>
						<i-col span="11">
							<FormItem prop="idMax">
								<InputNumber v-model="searchForm.idMax" placeholder="请输入结束企业交通业绩编号" style="width: 100%;" />
							</FormItem>
						</i-col>
					</Row>
				</FormItem>
				...
				<FormItem label="技术负责人" prop="technologyName">
					<Input v-model="searchForm.technologyName" placeholder="请输入技术负责人" />
				</FormItem>
				<FormItem label="合同金额" prop="contractAmount">
					<Input v-model="searchForm.contractAmount" placeholder="请输入合同金额" />
				</FormItem>
				<FormItem label="工程地点" prop="workAddr">
					<Input v-model="searchForm.workAddr" placeholder="请输入工程地点" />
				</FormItem>
				<FormItem label="开工时间">
					<Row>
						<i-col span="11">
					...
					<Row>
						<i-col span="11">
							<FormItem prop="endDateMin">
								<DatePicker @on-change="searchForm.endDateMin=$event" :value="searchForm.endDateMin" placeholder="请输入开始竣工时间"
								 type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
							</FormItem>
						</i-col>
						<i-col span="2" style="text-align: center">-</i-col>
						<i-col span="11">
							<FormItem prop="endDateMax">
								<DatePicker @on-change="searchForm.endDateMax=$event" :value="searchForm.endDateMax" placeholder="请输入结束竣工时间"
								 type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
							</FormItem>
						</i-col>
					</Row>
				...
				<FormItem label="验证状态" prop="validStatus">
					<Input v-model="searchForm.validStatus" placeholder="请输入验证状态" />
				</FormItem>
				<FormItem label="版本号">
					<Row>
						<i-col span="11">
		...
		<Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
			<p>企业交通业绩编号: <span v-text="form.id"></span></p>
			...
			<p>验证状态: <span v-text="form.validStatus"></span></p>
	...
	export default {
		...
		data() {
			return {
				...
				urls: {
					addUrl: '/comp-traffic-achievement/admin/save',
					batchAddUrl: '/comp-traffic-achievement/admin/batch-save',
					editUrl: '/comp-traffic-achievement/admin/update',
					batchEditUrl: '/comp-traffic-achievement/admin/batch-update',
					searchUrl: '/comp-traffic-achievement/admin/pager-cond',
					allUrl: '/comp-traffic-achievement/admin/all',
					removeUrl: '/comp-traffic-achievement/admin/remove/',
					batchRemoveUrl: '/comp-traffic-achievement/admin/batch-remove',
					detailUrl: '/comp-traffic-achievement/admin/one/',
					activeUrl: '/comp-traffic-achievement/admin/active',
					batchActiveUrl: '/comp-traffic-achievement/admin/batch-active'
				},
				page: {
					total: 0
				},
