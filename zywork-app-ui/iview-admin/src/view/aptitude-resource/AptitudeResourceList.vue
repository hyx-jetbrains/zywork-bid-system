<template>
  <div>
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="aptitudeIdMin">
                <InputNumber
                  v-model="searchForm.aptitudeIdMin"
                  placeholder="请输入开始资质编号"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
            ...
            <i-col span="11">
              <FormItem prop="aptitudeIdMax">
                <InputNumber
                  v-model="searchForm.aptitudeIdMax"
                  placeholder="请输入结束资质编号"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
    ...
    <Modal v-model="modal.detail" title="详情">
      ...
      <p>
        资质编号:
        <span v-text="form.aptitudeId"></span>
      </p>
      <p>
        资源编号:
...
export default {
  ...
  mounted() {
    if (this.aptitudeId !== undefined) {
      this.searchForm.aptitudeId 
            = this.searchForm.aptitudeIdMin
            = this.searchForm.aptitudeIdMax
            = this.aptitudeId
    }
    this.search()
  },
