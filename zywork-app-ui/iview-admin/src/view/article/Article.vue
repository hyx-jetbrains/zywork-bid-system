  ...
  <div>
    ...
    >
      ...
      <div slot="footer">
        ...
        <Button type="primary" size="large" @click="add" :loading="loading.add">发布文章</Button>
      </div>
    </Modal>
    <Modal
      v-model="modal.edit"
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="categoryIdMin">
                <InputNumber
                  v-model="searchForm.categoryIdMin"
                  placeholder="请输入开始类别编号"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
            ...
            <i-col span="11">
              <FormItem prop="categoryIdMax">
                <InputNumber
                  v-model="searchForm.categoryIdMax"
                  placeholder="请输入结束类别编号"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="viewCountMin">
                <InputNumber
                  v-model="searchForm.viewCountMin"
                  placeholder="请输入开始阅读量"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
            ...
            <i-col span="11">
              <FormItem prop="viewCountMax">
                <InputNumber
                  v-model="searchForm.viewCountMax"
                  placeholder="请输入结束阅读量"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
        ...
        <FormItem label="创建人编号">
          <Row>
            <i-col span="11">
              <FormItem prop="createIdMin">
                <InputNumber
                  v-model="searchForm.createIdMin"
                  placeholder="请输入开始创建人编号"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
            ...
            <i-col span="11">
              <FormItem prop="createIdMax">
                <InputNumber
                  v-model="searchForm.createIdMax"
                  placeholder="请输入结束创建人编号"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
    ...
    >
      ...
      <p>封面图片:
        <span v-text="form.coverImg"></span>
      </p>
      <p>文章摘要:
      ...
      <p>创建人编号:
        <span v-text="form.createId"></span>
      </p>
      <p>创建时间:
      ...
      getArticleCategorySelect()
        .then(res => {
          ...
          if (data.data.total !== 0) {
            this.articleCategorySelect = data.data.rows
          }
        })
        .catch(err => {
