...
<FormItem label="URL链接" prop="url">
	<Input v-model="form.url" placeholder="请输入URL链接"/>
</FormItem>
...
<FormItem label="URL链接" prop="url">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="业绩编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始业绩编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束业绩编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
...
<FormItem label="URL链接" prop="url">
	<Input v-model="searchForm.url" placeholder="请输入URL链接"/>
</FormItem>
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>业绩编号: <span v-text="form.id"></span></p>
<p>用户编号: <span v-text="form.userId"></span></p>
<p>URL链接: <span v-text="form.url"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/achievement/admin/save',
          batchAddUrl: '/achievement/admin/batch-save',
          editUrl: '/achievement/admin/update',
          batchEditUrl: '/achievement/admin/batch-update',
          searchUrl: '/achievement/admin/pager-cond',
          allUrl: '/achievement/admin/all',
          removeUrl: '/achievement/admin/remove/',
          batchRemoveUrl: '/achievement/admin/batch-remove',
          detailUrl: '/achievement/admin/one/',
          activeUrl: '/achievement/admin/active',
          batchActiveUrl: '/achievement/admin/batch-active'
        },
        page: {
          total: 0
        },
