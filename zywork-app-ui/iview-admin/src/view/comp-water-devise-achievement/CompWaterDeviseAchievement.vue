...
<FormItem label="项目类型" prop="tenderingComp">
	<Input v-model="form.tenderingComp" placeholder="请输入项目类型"/>
</FormItem>
...
<FormItem label="中标时间" prop="markDate">
	<DatePicker @on-change="form.markDate=$event" :value="form.markDate" placeholder="请输入中标时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
