		...
		<Modal v-model="modal.add" title="添加" @on-visible-change="changeModalVisibleResetForm('addForm', $event)">
			<Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
				...
				<FormItem label="出生年份" prop="birthday">
					<DatePicker @on-change="form.birthday=$event" :value="form.birthday" placeholder="请输入出生年份" type="datetime" format="yyyy-MM-dd HH:mm:ss"
					...
					<Row>
						<i-col span="11">
							<FormItem prop="birthdayMin">
								<DatePicker @on-change="searchForm.birthdayMin=$event" :value="searchForm.birthdayMin" placeholder="请输入开始出生年份"
						...
						<i-col span="11">
							<FormItem prop="birthdayMax">
								<DatePicker @on-change="searchForm.birthdayMax=$event" :value="searchForm.birthdayMax" placeholder="请输入结束出生年份"
								 type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
							</FormItem>
						</i-col>
					</Row>
