<template>
  <div>
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="endTimeMin">
                <DatePicker
                  @on-change="searchForm.endTimeMin=$event"
                  :value="searchForm.endTimeMin"
                  placeholder="请输入开始截止时间"
                  type="datetime"
                  format="yyyy-MM-dd HH:mm:ss"
                  style="width: 100%;"
                ></DatePicker>
            ...
            <i-col span="11">
              <FormItem prop="endTimeMax">
                <DatePicker
                  @on-change="searchForm.endTimeMax=$event"
                  :value="searchForm.endTimeMax"
                  placeholder="请输入结束截止时间"
                  type="datetime"
                  format="yyyy-MM-dd HH:mm:ss"
                  style="width: 100%;"
                ></DatePicker>
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="stickStatusMin">
                <InputNumber
                  v-model="searchForm.stickStatusMin"
                  placeholder="请输入开始置顶状态"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
            ...
            <i-col span="11">
              <FormItem prop="stickStatusMax">
                <InputNumber
                  v-model="searchForm.stickStatusMax"
                  placeholder="请输入结束置顶状态"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
    ...
    >
      ...
      <p>置顶状态:
        <span v-text="form.stickStatus"></span>
      </p>
      <p>版本号:
