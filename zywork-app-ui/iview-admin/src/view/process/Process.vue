    ...
    >
      <Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
        <FormItem label="流程Name" prop="processName">
          <Input v-model="form.processName" placeholder="请输入流程Name，和配置文件的name保持一致"/>
        </FormItem>
        <FormItem label="流程Key" prop="processKey">
          <Input v-model="form.processKey" placeholder="请输入流程Key，和配置文件的key保持一致"/>
        </FormItem>
        <!--
<FormItem label="流程文件路径" prop="filePath">
	<Input v-model="form.filePath" placeholder="请输入流程文件路径"/>
        ...
        <FormItem label="流程描述" prop="description">
          <Input v-model="form.description" type="textarea" :autosize="descriptionAutoSize" placeholder="请输入流程描述"/>
        </FormItem>
        ...
        <FormItem label="部署时间" prop="deployTime">
          <DatePicker
            @on-change="form.deployTime=$event"
...
<FormItem label="部署时间" prop="deployTime">
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="isDeployMin">
                <InputNumber
                  v-model="searchForm.isDeployMin"
                  placeholder="请输入开始是否部署"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
            ...
            <i-col span="11">
              <FormItem prop="isDeployMax">
                <InputNumber
                  v-model="searchForm.isDeployMax"
                  placeholder="请输入结束是否部署"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="deployTimeMin">
                <DatePicker
                  @on-change="searchForm.deployTimeMin=$event"
                  :value="searchForm.deployTimeMin"
                  placeholder="请输入开始部署时间"
                  type="datetime"
                  format="yyyy-MM-dd HH:mm:ss"
                  style="width: 100%;"
                ></DatePicker>
            ...
            <i-col span="11">
              <FormItem prop="deployTimeMax">
                <DatePicker
                  @on-change="searchForm.deployTimeMax=$event"
                  :value="searchForm.deployTimeMax"
                  placeholder="请输入结束部署时间"
                  type="datetime"
                  format="yyyy-MM-dd HH:mm:ss"
                  style="width: 100%;"
                ></DatePicker>
    ...
    >
      ...
      <p>流程Name:
        <span v-text="form.processName"></span>
      </p>
      <p>流程Key:
        <span v-text="form.processKey"></span>
      </p>
      <p>流程文件路径:
        <span v-text="form.filePath"></span>
      </p>
      <p>流程描述:
        <span v-text="form.description"></span>
      </p>
      <p>是否部署:
        <span v-text="form.isDeploy"></span>
      </p>
      <p>部署时间:
        <span v-text="form.deployTime"></span>
      </p>
      <p>版本号:
