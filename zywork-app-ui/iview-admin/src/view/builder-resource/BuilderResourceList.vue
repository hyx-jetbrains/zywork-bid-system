          ...
          <Row>
            <i-col span="11">
              <FormItem prop="builderIdMin">
                <InputNumber
                  v-model="searchForm.builderIdMin"
            ...
            <i-col span="11">
              <FormItem prop="builderIdMax">
                <InputNumber
                  v-model="searchForm.builderIdMax"
...
export default {
  ...
  mounted() {
    ...
    if (this.builderId !== undefined) {
      this.searchForm.builderId 
          = this.searchForm.builderIdMin 
          = this.searchForm.builderIdMax 
          = this.builderId
    }
    this.search()
  },
