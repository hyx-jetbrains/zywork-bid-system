<template>
  <div>
    ...
    >
      <Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
        ...
        <FormItem label="回复时间" prop="replyTime">
          <DatePicker
            @on-change="form.replyTime=$event"
    ...
    >
      ...
      <p>
        问题说明:
        <span v-text="form.consultDesc"></span>
      </p>
      <p>
        回复人编号:
