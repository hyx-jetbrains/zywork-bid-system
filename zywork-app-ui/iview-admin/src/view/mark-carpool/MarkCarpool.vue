  ...
  <div>
    ...
    >
      <Form ref="editForm" :model="form" :label-width="80" :rules="validateRules">
        <FormItem label="项目编号" prop="projectId">
          <Input v-model="form.projectId" readonly/>
        </FormItem>
        <FormItem label="城市" prop="city">
          <Cascader
            :data="cityData"
    ...
    <Modal :transfer="false" fullscreen v-model="modal.userDetalSearch" title="搜索主表信息">
      ...
      <div slot="footer">
        <Button type="text" size="large" @click="cancelModal('moduleSeƒarch')">取消</Button>
...
import { isActiveSelect, carType } from '@/api/select'
