...
<FormItem label="备注" prop="memo">
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="专家问题分类编号"><Row>
	<i-col span="11">
	<FormItem prop="idMin">
	<InputNumber v-model="searchForm.idMin" placeholder="请输入开始专家问题分类编号" style="width: 100%;"/>
</FormItem>
</i-col>
	<i-col span="2" style="text-align: center">-</i-col>
	<i-col span="11">
	<FormItem prop="idMax">
	<InputNumber v-model="searchForm.idMax" placeholder="请输入结束专家问题分类编号" style="width: 100%;"/>
</FormItem>
</i-col>
</Row>
</FormItem>
<FormItem label="类别名称" prop="name">
	<Input v-model="searchForm.name" placeholder="请输入类别名称"/>
</FormItem>
<FormItem label="备注" prop="memo">
...
<FormItem label="是否激活"><Row>
    ...
    <Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
      <p>专家问题分类编号: <span v-text="form.id"></span></p>
<p>类别名称: <span v-text="form.name"></span></p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/experquestion-type/admin/save',
          batchAddUrl: '/experquestion-type/admin/batch-save',
          editUrl: '/experquestion-type/admin/update',
          batchEditUrl: '/experquestion-type/admin/batch-update',
          searchUrl: '/experquestion-type/admin/pager-cond',
          allUrl: '/experquestion-type/admin/all',
          removeUrl: '/experquestion-type/admin/remove/',
          batchRemoveUrl: '/experquestion-type/admin/batch-remove',
          detailUrl: '/experquestion-type/admin/one/',
          activeUrl: '/experquestion-type/admin/active',
          batchActiveUrl: '/experquestion-type/admin/batch-active'
        },
        page: {
          total: 0
        },
