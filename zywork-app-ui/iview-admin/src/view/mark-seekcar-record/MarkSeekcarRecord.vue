...
<FormItem label="找车编号" prop="markSeekcarId">
	<InputNumber v-model="form.markSeekcarId" placeholder="请输入找车编号" style="width: 100%;"/>
</FormItem>
  ...
  export default {
    ...
    data() {
      return {
        ...
        urls: {
          addUrl: '/mark-seekcar-record/admin/save',
          batchAddUrl: '/mark-seekcar-record/admin/batch-save',
          editUrl: '/mark-seekcar-record/admin/update',
          batchEditUrl: '/mark-seekcar-record/admin/batch-update',
          searchUrl: '/mark-seekcar-record/admin/pager-cond',
          allUrl: '/mark-seekcar-record/admin/all',
          removeUrl: '/mark-seekcar-record/admin/remove/',
          batchRemoveUrl: '/mark-seekcar-record/admin/batch-remove',
          detailUrl: '/mark-seekcar-record/admin/one/',
          activeUrl: '/mark-seekcar-record/admin/active',
          batchActiveUrl: '/mark-seekcar-record/admin/batch-active'
        },
        page: {
          total: 0
        },
