	...
	<div>
		...
		<Modal v-model="modal.search" title="高级搜索">
			<Form ref="searchForm" :model="searchForm" :label-width="80">
				<FormItem label="企业水利业绩编号">
					<Row>
						<i-col span="11">
							<FormItem prop="idMin">
								<InputNumber v-model="searchForm.idMin" placeholder="请输入开始企业水利业绩编号" style="width: 100%;" />
							</FormItem>
						</i-col>
						<i-col span="2" style="text-align: center">-</i-col>
						<i-col span="11">
							<FormItem prop="idMax">
								<InputNumber v-model="searchForm.idMax" placeholder="请输入结束企业水利业绩编号" style="width: 100%;" />
							</FormItem>
						</i-col>
					</Row>
				</FormItem>
		...
		<Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
			<p>企业水利业绩编号: <span v-text="form.id"></span></p>
	...
	export default {
		...
		data() {
			return {
				...
				urls: {
					addUrl: '/comp-water-achievement/admin/save',
					batchAddUrl: '/comp-water-achievement/admin/batch-save',
					editUrl: '/comp-water-achievement/admin/update',
					batchEditUrl: '/comp-water-achievement/admin/batch-update',
					searchUrl: '/comp-water-achievement/admin/pager-cond',
					allUrl: '/comp-water-achievement/admin/all',
					removeUrl: '/comp-water-achievement/admin/remove/',
					batchRemoveUrl: '/comp-water-achievement/admin/batch-remove',
					detailUrl: '/comp-water-achievement/admin/one/',
					activeUrl: '/comp-water-achievement/admin/active',
					batchActiveUrl: '/comp-water-achievement/admin/batch-active'
				},
				page: {
					total: 0
				},
		...
		methods: {
			...
			setPrice(type) {
				...
				// 	}
        // }
        this.from.money = this.form.contractAmount
			},
			add() {
				this.setPrice(1)
				utils.add(this)
