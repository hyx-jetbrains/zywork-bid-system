  ...
  <div>
    ...
    >
      <Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
        ...
        <FormItem label="审核状态" prop="examineStatus">
          <Select v-model="form.examineStatus" placeholder="请选审核状" clearable filterable>
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="examineStatusMin">
                <InputNumber
                  v-model="searchForm.examineStatusMin"
                  placeholder="请输入开始审核状态"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
            ...
            <i-col span="11">
              <FormItem prop="examineStatusMax">
                <InputNumber
                  v-model="searchForm.examineStatusMax"
                  placeholder="请输入结束审核状态"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
    ...
    >
      ...
      <p>
        审核状态:
        <span
          v-text="(form.examineStatus == '0' ? '审核中' : form.examineStatus == '1' ? '审核通过' : '审核不通过')"
        ></span>
      </p>
      <p>
        版本号:
...
import { gender, examine, jobType } from '@/api/select'
