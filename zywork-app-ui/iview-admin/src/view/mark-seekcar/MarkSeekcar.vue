  ...
  <div>
    ...
    <Modal v-model="modal.search" title="高级搜索">
      <Form ref="searchForm" :model="searchForm" :label-width="80">
        <FormItem label="开标找车编号">
          <Row>
            <i-col span="11">
              <FormItem prop="idMin">
                <InputNumber
                  v-model="searchForm.idMin"
                  placeholder="请输入开始开标找车编号"
                  style="width: 100%;"
                />
              </FormItem>
            </i-col>
          ...
          <Row>
            <i-col span="11">
              <FormItem prop="startTimeMin">
                <DatePicker
                  @on-change="searchForm.startTimeMin=$event"
                  :value="searchForm.startTimeMin"
                  placeholder="请输入开始出发时间"
                  type="datetime"
                  format="yyyy-MM-dd HH:mm:ss"
                  style="width: 100%;"
                ></DatePicker>
            ...
            <i-col span="11">
              <FormItem prop="startTimeMax">
                <DatePicker
                  @on-change="searchForm.startTimeMax=$event"
                  :value="searchForm.startTimeMax"
                  placeholder="请输入结束出发时间"
                  type="datetime"
                  format="yyyy-MM-dd HH:mm:ss"
                  style="width: 100%;"
                ></DatePicker>
    ...
    <Modal :transfer="false" fullscreen v-model="modal.userChoice" title="选择用户">
      ...
      <div slot="footer">
		...
		<Modal width="1000" v-model="modal.markSeekcarRecord" :markSeekcarId="markSeekcarId" title="找车记录">
...
export default {
  ...
  data() {
    return {
      ...
      urls: {
        addUrl: '/mark-seekcar/admin/save',
        batchAddUrl: '/mark-seekcar/admin/batch-save',
        editUrl: '/mark-seekcar/admin/update',
        batchEditUrl: '/mark-seekcar/admin/batch-update',
        searchUrl: '/mark-seekcar/admin/pager-cond',
        allUrl: '/mark-seekcar/admin/all',
        removeUrl: '/mark-seekcar/admin/remove/',
        batchRemoveUrl: '/mark-seekcar/admin/batch-remove',
        detailUrl: '/mark-seekcar/admin/one/',
        activeUrl: '/mark-seekcar/admin/active',
        batchActiveUrl: '/mark-seekcar/admin/batch-active'
      },
      page: {
        total: 0
      },
