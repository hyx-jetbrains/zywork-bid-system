...
<FormItem label="出发时间" prop="startTime">
	<DatePicker @on-change="form.startTime=$event" :value="form.startTime" placeholder="请输入出发时间" type="datetime" format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"></DatePicker>
</FormItem>
