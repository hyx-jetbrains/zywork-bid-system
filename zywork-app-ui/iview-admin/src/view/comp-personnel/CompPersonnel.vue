	...
	<div>
		...
		<Modal v-model="modal.add" title="添加" @on-visible-change="changeModalVisibleResetForm('addForm', $event)">
			<Form ref="addForm" :model="form" :label-width="80" :rules="validateRules">
				...
				<FormItem label="职称" prop="jobTitle">
					<Input v-model="form.jobTitle" placeholder="请输入职称" />
				</FormItem>
				<FormItem label="职业资格及专业" prop="jobDetail">
					<Select
					  v-model="form.jobDetail"
					  placeholder="请输入职业资格及专业"
					  clearable
					  filterable
						@on-change="initJobDetail"
					>
						<i-option v-for="item in jobDetailList" :value="item.value" :key="item.key">{{item.label}}</i-option>
					</Select>
				</FormItem>
		...
		<Modal v-model="modal.search" title="高级搜索">
			<Form ref="searchForm" :model="searchForm" :label-width="80">
				<FormItem label="企业人员编号">
					<Row>
						<i-col span="11">
							<FormItem prop="idMin">
								<InputNumber v-model="searchForm.idMin" placeholder="请输入开始企业人员编号" style="width: 100%;" />
							</FormItem>
						</i-col>
						<i-col span="2" style="text-align: center">-</i-col>
						<i-col span="11">
							<FormItem prop="idMax">
								<InputNumber v-model="searchForm.idMax" placeholder="请输入结束企业人员编号" style="width: 100%;" />
							</FormItem>
						</i-col>
					</Row>
				</FormItem>
				...
				<FormItem label="职称" prop="jobTitle">
					<Input v-model="searchForm.jobTitle" placeholder="请输入职称" />
				</FormItem>
				<FormItem label="职业资格及专业" prop="jobDetail">
					<Input v-model="searchForm.jobDetail" placeholder="请输入职业资格及专业" />
				</FormItem>
				<FormItem label="版本号">
					<Row>
						<i-col span="11">
		...
		<Modal v-model="modal.detail" title="详情" @on-visible-change="changeModalVisibleResetForm('editForm', $event)">
			<p>企业人员编号: <span v-text="form.id"></span></p>
			<p>企业编号: <span v-text="form.compId"></span></p>
			<p>姓名: <span v-text="form.name"></span></p>
			<p>职称: <span v-text="form.jobTitle"></span></p>
			<p>职业资格及专业: <span v-text="form.jobDetail"></span></p>
...
<script>
	...
	import {certificateType} from '@/api/select'
	...
	export default {
		...
		data() {
			return {
				...
				urls: {
					addUrl: '/comp-personnel/admin/save',
					batchAddUrl: '/comp-personnel/admin/batch-save',
					editUrl: '/comp-personnel/admin/update',
					batchEditUrl: '/comp-personnel/admin/batch-update',
					searchUrl: '/comp-personnel/admin/pager-cond',
					allUrl: '/comp-personnel/admin/all',
					removeUrl: '/comp-personnel/admin/remove/',
					batchRemoveUrl: '/comp-personnel/admin/batch-remove',
					detailUrl: '/comp-personnel/admin/one/',
					activeUrl: '/comp-personnel/admin/active',
					batchActiveUrl: '/comp-personnel/admin/batch-active'
				},
				page: {
					total: 0
				},
		...
		methods: {
			...
			confirmSelection(id) {
				console.log(this.modal.operate)
